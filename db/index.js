...
// Function to create a user and give it 4 keys
async function createUser({ 
  ...
  try {
    ...
    //in this try above we push the keys onto the user we made. If there is a duplicate username, it won't activate
...
async function createInitialTags() {
  ...
  async function updatePost(postId, fields = {}) {
    ...
    try {
      ...
      // return early if there's no tag to update
      if (tags === undefined) {
        return await getPostById(postId);
      }
